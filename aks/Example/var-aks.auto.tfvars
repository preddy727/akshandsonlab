...
aks_clusters = {
  "aks1" = {
    ...
    aks_default_pool = {
      ...
      max_pods                  = 30
      os_disk_size_gb           = 30
      subnet_id                 = "/subscriptions/[__subscription_id__]/resourceGroups/[__networking_resource_group_name__]/providers/Microsoft.Network/virtualNetworks/[__virtual_network_name__]/subnets/aks"
      node_count                = 1
      min_count                 = 1
      max_count                 = 1
...
ado_aks_private_connection_name = "ado-to-aks-jstartaksdev08252021a"
...
acr_name                    =  "msftdevdevopsacr"
acr_resource_group_name     = "[__ado_resource_group_name__]"
acr_rg_location             = "eastus2"
acr_subnet_name             = "[__ado_subnet_name__]"
acr_vnet_name               = "[__ado_vnet_name__]"
