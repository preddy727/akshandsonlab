...
route_tables = {
  rt1 = {
    name                          = "aksdemo_routetable"
    disable_bgp_route_propagation = false
    subnet_names                  = ["/subscriptions/c2483929-bdde-40b3-992e-66dd68f52928/resourceGroups/aksdemo_rg/providers/Microsoft.Network/virtualNetworks/aksdemo_vnet/subnets/aks"]
    tags                          = {}
    routes = [{
      name                   = "externalroute"
      address_prefix         = "0.0.0.0/0"
      next_hop_type          = "VirtualAppliance"
      next_hop_in_ip_address = "52.184.219.200"
      azure_firewall_name    = "aksfirewall2035"
    }]
  }
}
